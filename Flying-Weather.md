...
* the air is carried downwind while it is oscillating, so it traces the path of wave。
...
* To be conservative (i.e. extra safe), weather observers should always assume that：
